...
- **Highlight → 전용 노트 생성** — 책별 하위 폴더에 프론트매터 포함 노트 자동 생성
- **시각 보조** — 카테고리 컬러 칩, 상대 시간 배지, 검색어 마킹, 정렬 옵션(관련도/최근/책별)
...
5. 검색어 입력 → 결과 카드에서:
   ...
   - **노트 생성** 버튼 → `Readwise/{책}/{스니펫}.md` 전용 노트
